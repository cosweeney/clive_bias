...
from JoCond.jocond.joint import *
...
# compute # of galaxies in (R, r_los) bins
n_gal = 0.014 # (Mpc/h)^-3
rmax = 40
rlos_edges = np.linspace(-rmax, rmax, 2*rmax+1)
...
def compute_all_los_velocities_parallel(R_cens, rlos_vals, Mvirs, joint_MAP, cosmo, 
                                       output_file= samp_path+'gal_model_bin_mass_samples_r_5_15_model_dens.hdf5', n_processes=None):
    """
